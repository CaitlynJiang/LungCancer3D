            ...
            <div id="tab1_1">
                ...
                <c:if test="${!matched.isEmpty()}">
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                        <c:forEach items="${matchedDrugLabel}" var="item" varStatus="loop">
                            <tr>
                                <td>${loop.index + 1}</td>
            ...
            <div id="tab1_2">
                ...
                <c:if test="${!matched.isEmpty()}">
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                        <c:forEach items="${matchedDosingGuideline}" var="item" varStatus="loop">
                            <tr>
                                <td>${loop.index + 1}</td>
            ...
            <div id="tab1_3">
                ...
                <c:if test="${!matched.isEmpty()}">
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                        <c:forEach items="${matched_clinic_ann_by_snp}" var="item" varStatus="loop">
                            <tr>
                                <td>${loop.index + 1}</td>
                                <td>${item.location}</td>
                                <td>${item.gene}</td>
            ...
            <div id="tab1_4">
                ...
                <c:if test="${!matched.isEmpty()}">
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                        <c:forEach items="${matched_clinic_ann_by_gene}" var="item" varStatus="loop">
                            <tr>
                                <td>${loop.index + 1}</td>
                                <td>${item.location}</td>
                                <td>${item.gene}</td>
